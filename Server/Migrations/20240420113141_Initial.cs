    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventIdentityUser", x => new { x.EventId, x.IdentityUserId });
                    table.ForeignKey(
                        name: "FK_EventIdentityUser_Events_EventId",
                        column: x => x.EventId,
                        principalSchema: "identity",
                        principalTable: "Events",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EventIdentityUser_Users_IdentityUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventIdentityUser_IdentityUserId",
                schema: "identity",
                table: "EventIdentityUser",
